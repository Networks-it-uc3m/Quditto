...
# Main functions of this library: install, run and stop:

# This function installs and configures everything in a node to become a QKD node based on simulaqron

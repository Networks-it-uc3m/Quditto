class Module:
    """
    This function initialises a module over the polynomial
    ring "ring".
    """
    ...
    """
    This function generates a random element of the module
    of dimension m x n.
    ...
    """
    This function constructs a vector given a list of
    elements of the module's ring.
...
class Matrix:
    ...
    """
    This function ensures that the matrix is rectangular.
    """
    def _check_dimensions(self):
        return len(set(map(len, self._data))) == 1

    """
    This function returns a matrix with the rows and
    columns of swapped.
    """
    def transpose(self):
    ...
    """
    This functions swap the rows and columns of the
    matrix in place.
    """
    ...
    """
    This functions reduces every element in the polynomial
    ...
    """
    This function returns -self, by negating all elements.
    """
    def __neg__(self):  
        m, n = self.dim()
        return self.parent(

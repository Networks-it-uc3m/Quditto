...
class ModuleKyber(Module):
    ...
    """
    This function decodes bytes into a vector of polynomial elements.
    ...
    def decode_vector(self, input_bytes, k, d, is_ntt=False):
        # Ensure the input bytes are the correct length to create "k" 
        # elements with "d" bits used for each coefficient:
        ...
        # Outputs a vector with the encoded elements
...
class MatrixKyber(Matrix):
    ...
    """
    This function encodes every element of a matrix into bytes
    and concatenate.
    """
    def encode(self, d):
        output = b""
    ...
    """
    This function compresses every element of the matrix to have
    at most "d" bits.
    """
    def compress(self, d):
        for row in self._data:
    ...
    """
    This function performs lossy decompression of the polynomial
    assuming it has been compressed to have at most "d" bits.
    """
    ...
    """
    This function converts every element of the matrix into NTT form.
    """
    def to_ntt(self):
    ...
    """
    This function converts every element of the matrix from NTT form.
    """
    def from_ntt(self):

"""
This code fulfills the randomness generation requirement for ML-KEM implementation,
where random bytes shall be generated using an approved "RBG", as prescribed in the
document "SP 800-90A".
"""
import os
...
class AES256_CTR_DRBG:
    ...
    """
    This function combines the input seed and optional personalisation
    ...
    """
    This function increments the internal counter of the DRBG.
    """
    ...
    """
    This function updates the internal state of the CTR_DRBG
    using the provided_data.
    ...
    """
    This functions generates pseudorandom bytes without a generating
    function.

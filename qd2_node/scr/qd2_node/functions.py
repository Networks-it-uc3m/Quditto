...
def get_key_QKD(origin=None, node=None, key=None):
    ...
    with open("qkd_node/quditto_v2.yaml") as f:
...
def get_key_PQC(node_ip=None):
    ...
    command = ['python3', 'pqc_node/client.py', '-ip', str(node_ip)]
...
def get_key_with_ID_PQC(node_ip, key_ID):
    ...
    command = ['python3', 'pqc_node/client.py', '-ip', str(node_ip), '-id', str(key_ID)]
